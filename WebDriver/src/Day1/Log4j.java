...
public class Log4j {
	...
	public static void main(String[] args) {
		...
		//download Log4j jar and add those jar files
		//create log4j.xml file (copy and paste commands using above link) and add to the project directory
		//write script and run
		//check out the result in logfile.txt
